        ...
        if self.name=='stl10':
            ...
            if self.mismatch=='darp':
                ...
                for c in range(num_classes):
                    ...
                    idx = np.random.choice(idx, 450, True)
                    lt_len = round(450 * math.pow(self.n0,-(c/9)))
                ...
                info = '\nlabels: {}, mismatch: {}, N0: {}, gamma: {}'.format(len(lbs), self.mismatch, 'none' if self.n0==0 else str(self.n0),str(1) if self.gamma==0 else str(self.gamma))
