...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset=='miniimage':
        ...
        data_para_dict = dict(
            ...
            n_labeled_class_max=args.n0,
            long_tail_gamma=args.gamma,
        )
        save_path = os.path.join(args.save_dir, args.save_name)
        ...
        train_dset = SSL_Dataset(name=args.dataset, train=True, 
                                num_classes=args.num_classes, data_dir=args.data_dir, fold=args.fold, noisy=args.noisy, noisy_ratio=args.noisy_ratio,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_name', type=str, default='miniimage')
    ...
    parser.add_argument('--dataset', type=str, default='miniimage')
    ...
    parser.add_argument('--mismatch', type=str, default='rda', choices=['none','rda','darp','darp_reversed'], help='type of mismatched distribution')
    parser.add_argument('--n0', type=int, default=40, help='imbalanced ratio for labeled data')
